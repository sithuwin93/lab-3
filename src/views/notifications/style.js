...
export const NotificationCard = styled.div`
  ...
  overflow: hidden;
  position: relative;
  border-bottom: 1px solid ${props => themed({ light: props.theme.bg.border, dark: props.theme.bgd.border})};
  ${props =>
    props.isSeen === false &&
    css`
      box-shadow: inset 2px 0 0 ${themed({ light:theme.brand.default , dark:theme.brandd.default })};
      background: ${() => themed({ light: hexa(theme.brand.default, 0.06), dark: hexa(theme.brandd.default, 0.06)})};
    `}

  &:hover {
    background: ${props =>
      props.isSeen ? theme.bg.wash : 
...
export const SegmentedNotificationCard = styled(Card)`
  ...
  box-shadow: ${Shadow.low} ${({ theme }) => 
    themed({ light: hexa(theme.text.default, 0.1), dark: hexa(theme.textd.default, 0.1)})};
  ...
  ${props =>
    props.isSeen === false &&
    css`
      border-left: 2px solid ${themed({ light: theme.brand.default, dark:theme.brandd.default })};
      background: ${() => themed({ light: hexa(theme.brand.default, 0.06), dark:hexa(theme.brandd.default, 0.06) })};
    `}
`;
...
export const ContentWash = styled(Content)`
  ...
  background-color: ${props => 
    themed({ light:hexa(props.theme.bg.wash, 0.75) , dark:hexa(props.theme.bgd.wash, 0.75) })};
...
export const ChatMessage = styled.p`
  ...
  border-radius: 16px;
  font-size: 14px;
  background-color: ${() => themed({ light: theme.generic.alt, dark: theme.genericd.alt})};
  background-image: ${({ theme }) =>
    themed({ light:Gradient(theme.generic.alt, theme.generic.default) , 
      dark: Gradient(theme.genericd.alt, theme.genericd.default) })
    };
  float: left;
  max-width: 75%;
  margin-top: 24px;
...
export const NotificationListRow = styled(FlexCol)`
  ...
  overflow-x: hidden;
  box-shadow: ${props =>
    !props.isSeen ? `inset 2px 0 0 0 ${themed({ light: props.theme.brand.alt, dark:props.theme.brandd.alt })}` : 'none'};
  ...
  &:hover {
    ...
    themed({ light: hexa(theme.brand.wash, 0.15), dark:hexa(theme.brandd.wash, 0.15) }) };
    box-shadow: ${props =>
      !props.isSeen
        ? `inset 6px 0 0 0 ${themed({ light:props.theme.brand.alt , dark:props.theme.brandd.alt })}`
        : `inset 4px 0 0 0 ${themed({ light: props.theme.brand.alt, dark:props.theme.brandd.alt })}`};
    cursor: pointer;
  }
`;
...
export const SuccessContext = styled(ContextRow)`
  color: ${() => themed({ light:theme.success.alt , dark: theme.successd.alt})};
`;
...
export const JoinContext = styled(ContextRow)`
  color: ${() => themed({ light:theme.space.default , dark:theme.spaced.default })};
`;

export const RequestContext = styled(ContextRow)`
  color: ${() => themed({ light: theme.special.alt, dark: theme.speciald.alt})};
`;
