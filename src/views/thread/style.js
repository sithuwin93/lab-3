...
export const DetailViewWrapper = styled(FlexCol)`
  background-image: ${({ theme }) =>
    `linear-gradient(to right, ${themed({ light: theme.bg.wash, dark:theme.bgd.wash })},
     ${theme.bg.default} 15%, ${
      themed({ light:theme.bg.default , dark:theme.bgd.default })
    } 85%, ${themed({ light: theme.bg.wash, dark:theme.bgd.wash })})`};
  flex: auto;
...
export const FlyoutRow = styled(FlexRow)`
  ...
  button {
    width: 100%;
    justify-content: flex-start;
    border-top: 1px solid ${themed({ light:theme.bg.divider , dark:theme.bgd.divider })};
    border-radius: 0;
    transition: none;
    padding: 4px 12px;
    font-size: 13px;
...
export const PillLink = styled(Link)`
  font-size: 12px;
  box-shadow: 0 0 0 1px ${themed({ light: theme.bg.border, dark: theme.bgd.border})};
  background: ${() => themed({ light: theme.bg.wash, dark: theme.bgd.wash})};
  font-weight: 400;
  color: ${() => themed({ light: theme.text.alt, dark: theme.textd.alt})};
  display: flex;
...
export const PillLinkPinned = styled.div`
  ...
  border: 1px solid ${themed({ light: theme.special.border, dark: theme.speciald.border})};
...
export const SidebarCommunityProfile = styled.img`
  ...
  top: 48px;
  background: ${() => themed({ light:theme.bg.default , dark:theme.bgd.default })};
  border: 2px solid ${themed({ light: theme.bg.default, dark: theme.bgd.default})};
`;
