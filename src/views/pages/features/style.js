...
export const TextContent = styled.div`
  ...
  justify-self: center;
  z-index: 1;
  text-shadow: 0 0 4px ${themed({ light:theme.bg.default , dark:theme.bgd.default })};
  max-width: 560px;
    ...
    css`
      &:after {
        ...
        background-color: ${props =>
          props.bright ? 
          themed({ light:props.theme.success.alt , dark:props.theme.successd.alt }) 
          : themed({ light:props.theme.space.dark , dark: props.theme.spaced.dark})};
