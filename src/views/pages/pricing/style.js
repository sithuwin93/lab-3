...
export const Copy = styled.p`
  ...
  a {
    ...
    &:hover {
      color: ${() => themed({ light: theme.brand.dark, dark:theme.brandd.dark })};
    }
  }
...
export const PlanSection = styled.div`
  ...
  flex-direction: column;
  padding: 32px;
  box-shadow: 0 8px 32px ${props => themed({ light: hexa(props.theme.brand.alt, 0.25), dark: hexa(props.theme.brandd.alt, 0.25)}) };
...
export const FeaturePrice = styled.span`
  ...
  background: ${props =>
    props.color
      ...
      : themed({ light: hexa(props.theme.success.default, 0.08), dark:hexa(props.theme.successd.default, 0.08) })};
`;
