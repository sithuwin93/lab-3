...
export const Wrapper = styled(FlexCol)`
  ...
  border-top: 1px solid
    ${props => (props.border ? themed({ light: props.theme.bg.border, dark: props.theme.bgd.border}) : 'transparent')};
  ...
  &:hover > div > div h3,
  &:hover .action {
    color: ${props => (props.isClickable ? themed({ light: props.theme.brand.alt, dark: props.theme.brandd.alt}) : '')};
  }
`;
