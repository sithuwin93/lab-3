...
export const ShimmerSelect = styled.div`
  ...
  border-radius: 8px;
  background: ${() => themed({ light: theme.bg.default, dark: theme.bgd.default})};
  border: 2px solid ${themed({ light: theme.bg.border, dark:theme.bg.border })};
...
export const StyledErrorSelect = styled.div`
  ...
  border-radius: 8px;
  background: ${() => themed({ light:theme.bg.default , dark:theme.bgd.default })};
  border: 2px solid ${themed({ light:theme.warn.default , dark:theme.warnd.default })};
...
export const ShimmerLine = styled.span`
  ...
  background: linear-gradient(
    to right,
    ${themed({ light: theme.bg.wash, dark: theme.bgd.wash})} 10%,
    ${({ theme }) => themed({ light:hexa(theme.generic.default, 0.65) , dark:hexa(theme.genericd.default, 0.65) })} 20%,
    ${themed({ light:theme.bg.wash , dark:theme.bgd.wash })} 30%
  );
...
export const CircularCover = styled(Cover)`
  background: radial-gradient(
    transparent 20px,
    ${({ theme }) => themed({ light:theme.bg.default , dark:theme.bgd.default })} 10px
  );
`;
...
export const LoadingNavbarContainer = styled.nav`
  width: 100%;
  background: ${() => themed({ light:theme.text.default , dark:theme.textd.default })};
  display: flex;
  align-items: center;
  color: #fff;
