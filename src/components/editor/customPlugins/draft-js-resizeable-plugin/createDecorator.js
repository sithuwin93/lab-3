  ...
  class BlockResizeableDecorator extends Component {
    ...
    render() {
      ...
      if (horizontal === 'auto') {
        ...
        styles.width = `${width || blockProps.resizeData.width || 96}%`;
      } else if (horizontal === 'absolute') {
        styles.width = `${width || blockProps.resizeData.width || 96}px`;
      }

      if (vertical === 'auto') {
        styles.height = 'auto';
      } else if (vertical === 'relative') {
        styles.height = `${height || blockProps.resizeData.height || 96}%`;
      } else if (vertical === 'absolute') {
        styles.height = `${height || blockProps.resizeData.height || 96}px`;
      }
