...
export const Spinner = styled.span`
  ...
  &:before {
    ...
    border-right-color: ${props =>
      props.color ? eval(`props.theme.${props.color}`) :themed({ light: props.theme.brand.alt, dark: props.theme.brandd.alt}) };
...
export const Input = styled.input`
  ...
  width: 100%;
  font-size: 0.875rem;
  border: 0.125rem solid ${themed({ light: theme.bg.inactive, dark:theme.bgd.inactive })};
...
export const Onboarding = props => css`
  ...
  &:after {
    ...
    padding-left: 20px;
    border-radius: 12px;
    background-color: ${() => themed({ light: props.theme.bg.default, dark: props.theme.bgd.default})};
    background: ${() => themed({ light: props.theme.bg.default, dark:props.theme.bgd.default })} url(/img/goopy-top.svg) center top
      no-repeat;
    background-size: 100%;
...
export const HorizontalRule = styled(FlexRow)`
  ...
  align-items: center;
  align-self: stretch;
  color: ${() => themed({ light:theme.bg.border , dark: theme.bgd.border})};
