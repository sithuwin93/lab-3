...
const UsernameWrapper = styled.span`
  color: ${props =>
    props.me
      ...
      : themed({ light: props.theme.space.default, dark:props.theme.spaced.default })}!important;
  background: ${props =>
    props.me ? 
    themed({ light: props.theme.special.wash, dark:props.theme.speciald.wash }) : 
    themed({ light: props.theme.space.wash, dark: props.theme.spaced.wash})}!important;
  padding: 0px 4px 1px;
  border-radius: 4px;
  position: relative;
...
export const customStyleFn = (style: Object, block: Object) => {
  if (style.first() === 'CODE' && block.getType() === 'unstyled')
    return {
      ...
      borderRadius: '4px',
      backgroundColor: themed({ light: theme.bg.wash, dark:theme.bgd.wash }),
      padding: '1px 4px',
...
export const customStyleMap = {
  blockquote: {
    lineHeight: '1.5',
    borderLeft: `4px solid ${themed({ light: theme.bg.border, dark: theme.bgd.border})}`,
...
export const Expander = styled.div`
  ...
  ${props =>
    ...
    css`
      ...
      > button > div {
        color: ${() => themed({ light: theme.brand.wash, dark: theme.brandd.wash})};
  ...
  ${props =>
    ...
    css`
      ...
      button {
        ...
        &:hover {
          background-color: ${() => themed({ light:theme.brand.dark , dark:theme.brandd.dark })};
          border-radius: 8px;
          transition: ${Transition.hover.on};
        }
      }
