...
export const LoadingPill = styled.span`
  ...
  border: 1px solid ${themed({ light: theme.brand.default, dark:theme.brandd.default })};
  opacity: ${props => (props.isVisible ? '1' : '0')};
  pointer-events: none;
  z-index: 11;
  box-shadow: 0 2px 4px rgba(${themed({ light:hexa(theme.brand.alt, 0.12) , dark:hexa(theme.brandd.alt, 0.12) })});
`;
